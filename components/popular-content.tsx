...
//   //Card gives the 4 reccs

//   return (
//     <Card className="w-full max-h-[340px] rounded-md bg-white shadow-lg border-none flex flex-col items-center 
//     justify-center relative  py-6 pt-24 md:pt-28">
//       <div className="absolute -top-[4%] md:-top-[20%] overflow-hidden w-24 md:w-40 h-24 md:h-40 
